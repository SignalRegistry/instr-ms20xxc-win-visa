...
// Visa Parameters
ViStatus visaStatus;                        // Error checking
ViSession visaDefault, visaInstr;           // Instrument handler
ViUInt32 visaNumInstrs;                     // Number of found instruments
ViFindList visaFoundInstrList;              // Found instruments
ViChar visaFoundInstrBuffer[VI_FIND_BUFLEN];// buffer
